...
//    @JsonManagedReference
    @NotNull
    @ManyToMany(fetch = FetchType.LAZY,cascade = CascadeType.MERGE, targetEntity =  Author.class)
...
//    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
    @NotNull
    @ManyToMany(fetch = FetchType.LAZY, cascade = CascadeType.MERGE , targetEntity = Topic.class)
